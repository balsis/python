...
class WebElement(BaseWebElement):
    ...
    def get_dom_attribute(self, name) -> str:
        ...
        :func:`~selenium_stepik.webdriver.remote.BaseWebElement.get_attribute`, this
    ...
    def get_attribute(self, name) -> str | None:
        ...
        use :func:`~selenium_stepik.webdriver.remote.BaseWebElement.get_dom_attribute` or
        :func:`~selenium_stepik.webdriver.remote.BaseWebElement.get_property` methods respectively.
    ...
    @property
    def id(self) -> str:
        """Internal ID used by selenium_stepik.
