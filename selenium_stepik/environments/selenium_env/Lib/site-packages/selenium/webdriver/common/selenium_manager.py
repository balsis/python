...
class SeleniumManager:
    ...
    def get_binary() -> Path:
        ...
        if os.getenv("SE_MANAGER_PATH"):
            ...
            file = "selenium_stepik-manager.exe" if directory == "windows" else "selenium_stepik-manager"

            path = Path(__file__).parent.joinpath(directory, file)

        if not path.is_file() and os.environ["CONDA_PREFIX"]:
            # conda has a separate package selenium_stepik-manager, installs in bin
